...
#im_fpath = 'G:/Kaggle_a3d/0d10b14405f0443be67a75554da778a0.a3d'
#print(im_fpath)
#im_fpath = asas
im_fpath = 'G:/Kaggle_Label/'
#save_fpath = ''
...
ani_file_out = 'G:/Kaggle_Label/'#join(bsbs, fname_id + "_" + ext_no_dot + ".mp4")
...
def plot_image_aps_or_a3daps(path):
	...
	"""
	data = read_data(path)
	#np.save('E:/Kaggle_SavedData/Converta3d', data)    # change
...
def main():
	...
	# Convert the data file from .a3d to .mp4
	# read all the file names in a directory
	# store all the files name in a variable
	# loop through all the files names and convert to .mp4 files
	# save all the files in the specific directory with the corresponding name

	filepath = 'G:/Kaggle_a3d/0d10b14405f0443be67a75554da778a0.a3d'  # change
	plot_image_aps_or_a3daps(filepath)  	# change
